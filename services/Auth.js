...
export default {
    ...
    getcountapi(userid, siteId, cb) {
        api.getcount(userid, siteId, res => {
            cb(true, res);
        });
    },
    getListdataapi(UserID, SiteId, StatusID, token, cb) {
        api.getListdata(UserID, SiteId, StatusID, token, res => {
            cb(true, res);
        });
    },
    getcategoryapi(SiteID, cb) {
        api.getcategory(SiteID, res => {
            cb(true, res);
        });
    },
    getapqplist(UserID, SiteId, Index, maxRow, ListType, projectView, FilterValue, FilterColumn, OrderBy, Sorttype, StartDate, EndDate, Token, cb) {
        api.getapqp(
            UserID,
            SiteId,
            Index,
    ...
    filterapqplist(UserID, SiteId, Index, maxRow, ListType, projectView, startDate, endDate, Token, cb) {
        api.filterapqp(UserID, SiteId, Index, maxRow, ListType, projectView, startDate, endDate, Token, res => {
            cb(true, res);
        });
    },

    getapqplist2data(UserID, ProjectId, TaskId, MaxRow, ListType, ProjectView, Token, cb) {
        api.getapqp2(UserID, ProjectId, TaskId, MaxRow, ListType, ProjectView, Token, res => {
            cb(true, res);
        });
    },
    ...
    getRegistrationdata(RegisteredDeviceId, ServerUrl, RegisteredDate, Active, IsDeleted, UnRegisteredDate, cb) {
        api.getRegistrationList(RegisteredDeviceId, ServerUrl, RegisteredDate, Active, IsDeleted, UnRegisteredDate, res => {
            cb(true, res);
        });
    },
    ...
    saveperiodicupdate(Id, UserID, TaskId, FromPercent, Percent, ResourceID, StartDate, Hours, Remark, UpdateType, EndTime, Token, cb) {
        api.onsaveperiodicupdate(Id, UserID, TaskId, FromPercent, Percent, ResourceID, StartDate, Hours, Remark, UpdateType, EndTime, Token, res => {
            cb(true, res);
        });
    },
    ...
    getapqpDeliverableInfoList(ProjectId, TaskId, ResourceId, AccessType, Token, cb) {
        api.getapqpDeliverableInfoList(ProjectId, TaskId, ResourceId, AccessType, Token, res => {
            cb(true, res);
        });
    },

    getapqpOpenListdata(UserID, SiteID, Index, MaxRow, ListType, Token, FilterValue, FilterColumn, OrderBy, Sorttype, StartDate, EndDate, cb) {
    ...
    getapqpMeetingListdata(SiteID, UserID, Index, Max, Token, FilterValue, FilterColumn, OrderBy, Sorttype, StartDate, EndDate, cb) {
        api.getapqpMeetingListdata(SiteID, UserID, Index, Max, Token, FilterValue, FilterColumn, OrderBy, Sorttype, StartDate, EndDate, res => {
            cb(true, res);
        });
    },
    ...
    getapqpRiskListdata(UserID, SiteID, Index, Max, Token, FilterValue, FilterColumn, OrderBy, Sorttype, StartDate, EndDate, cb) {
        api.getapqpRiskListdata(UserID, SiteID, Index, Max, Token, FilterValue, FilterColumn, OrderBy, Sorttype, StartDate, EndDate, res => {
            cb(true, res);
        });
    },
    ...
    getDocProRequestDetails(ProjectId, TaskId, IsAdditional, UserId, Token, cb) {
        api.getDocProRequestDetails(ProjectId, TaskId, IsAdditional, UserId, Token, res => {
            cb(true, res);
        });
    },

    saveAttachments(ProjectId, TaskId, InputDocId, DocId, DocRevision, DocName, IPIdentity, ObjId, Comments, isAdditional, Token, cb) {
        api.saveAttachments(ProjectId, TaskId, InputDocId, DocId, DocRevision, DocName, IPIdentity, ObjId, Comments, isAdditional, Token, res => {
            cb(true, res);
        });
    },
