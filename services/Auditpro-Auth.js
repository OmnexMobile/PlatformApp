...
export default {
  ...
  loginUserPs(email, password, fcmToken, deviceId,loginFlag, isSSo, cb,) {
    console.log(email, password, fcmToken, deviceId, isSSo, 'helloconsole');
    api.loginPs(email, password, fcmToken, deviceId, loginFlag,isSSo, res => {
      cb(true, res);
    });
  },

  globalLogin(email, password, fcmToken, deviceId,loginFlag, isSSo, cb,) {
    console.log(email, password, fcmToken, deviceId, isSSo, 'helloconsole');
    api.globalLoginUser(email, password, fcmToken, deviceId, loginFlag,isSSo, res => {
      cb(true, res);
    });
  },
  ...
  globalRegisterDevice(deviceId, url, type, cb) {
    api.globalRegisterDevice(deviceId, url, type, res => {
      if (!res) {
        cb(false, res);
      } else {
        cb(true, res);
