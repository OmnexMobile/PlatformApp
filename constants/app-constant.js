...
export const ROUTES = {
    ...
    CREATE_ATTACHSM: 'CREATE_ATTACHSM',
    AUDIT_WEBVIEW: 'AUDIT_WEBVIEW',
    CAMERA_CAPTURE: 'CAMERA_CAPTURE',
    VIDEO_CAPTURE: 'VIDEO_CAPTURE',
    USER_PREFERENCE: 'USER_PREFERENCE',
    CHECKLIST_MENU_SM: 'CHECKLIST_MENU_SM',
    ...
    AUDIT_SCREEN_SM: 'AUDIT_SCREEN_SM',
