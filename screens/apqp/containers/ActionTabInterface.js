...
class ActionTabInterface extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      MaxRow: 10,
      Index: 1, //Edited_by_Sudha_13_07_2021
      sortOrder: "desc",
      OrderBy: "StartDate",
      // OrderBy: "Action",
      StartDate: "",
        ...
        this.setState(
          {
            ...
            isFileterApplied:
              // this.props.navigation.state.params &&
              // this.props.navigation.state.params.filterType == "Calendar"
              this.props?.route?.params &&
  ...
  */
    ...
    this.setState(
      {
        ...
        //Edited_by_Sudha_15_06_2021 -->Down
      ...
      () => {
        this.getActionlist("handle handleEnd");
      }
    );
  }
    ...
    this.setState(
      {
        isRefreshing: true,
        MaxRow: 10,
        // MaxRow: this.state.MaxRow + 10,//Edited_By_Sudha_16_09_2021
      },
      () => {
    ...
    this.setState(
      {
        ...
        // project_sortText: dropText == Reset ?  "Action": dropText,
        project_filterType: "Sort",
      },
      () => {
  ...
  changeProjectSort(value) {
    this.setState(
      ...
      () => {
        console.log("Check_Sort---->" + this.state.project_sort);
        this.applyFilterChanges(
          this.state.project_sort,
          this.state.project_sortText,
          this.state.project_filterType,
        ...
        <View style={styles.flatList}>
          <ScrollableTabView
            ...
            onChangeTab={(o) => {
              ...
              // else{
              //   this.onChangeText(this.state.project_sortText)
              // }
            }}
          >
            {this.allActions()}
  ...
  renderFilter() {
    console.log("---->Check---->filterSection--->2");
    return (
      <View
        style={{
          width: "100%",
  ...
  filterSection() {
    console.log("---->Check---->filterSection--->1");
    return (
  ...
  RenderActionFlashList() {
    console.log("---->Check---->filterSection--->3");
    return (
      <FlatList
      ...
      <ImageBackground source={Images.headerBG} style={styles.header}>
        <View style={styles.header}>
          ...
          <View style={styles.heading}>
            <Text style={styles.headingText}>{strings.Actions}</Text>
          </View>
  ...
  getAllProjectlist(res) {
    ...
    console.log(
      "@@@@@ ActionTabInterface calendarapi", SiteId
    );
    NetInfo.fetch().then((netStatus) => {
      if (netStatus.isConnected) {
