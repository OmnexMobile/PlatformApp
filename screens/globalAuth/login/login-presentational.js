        ...
        <View style={{ flex: 1, backgroundColor: COLORS.white }}>
            ...
            <KeyboardAwareScrollViewComponent keyboardShouldPersistTaps="always" style={{ flex: 1, backgroundColor: COLORS.transparent }}>
                <AnimatableView
                    ...
                    <TouchableOpacity activeOpacity={0.8} style={styles.icon} onPress={() => navigation.navigate(ROUTES.GLOBAL_REGISTER)}>
            ...
            {!isRegistered ? (
                <TouchableOpacity
                    activeOpacity={1}
                    onPress={() => navigation.navigate(ROUTES.GLOBAL_REGISTER)}
                    style={{
