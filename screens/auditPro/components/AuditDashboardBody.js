...
class AuditDashboardBody extends Component {
  ...
  componentWillReceiveProps(props) {
    ...
    // if (CurrentPage == ROUTES.AUDITPRODASHBOARD) {
      if (CurrentPage == ROUTES.GLOBAL_DASHBOARD || CurrentPage == ROUTES.HOME_FAB_VIEW) {
      // console.log('Audit List Component Focussed!')
...
const mapDispatchToProps = dispatch => {
  return {
    storeAudits: audits => 
      dispatch({type: 'STORE_AUDITS', audits}),
    ...
    storeDeviceid: deviceid => 
      dispatch({type: 'STORE_DEVICEID', deviceid}),
