...
class AuditCard extends Component {
    constructor(props) {
        ...
        this.state = {
            selectedFormat: this.props.dateFormat === null ? 'DD-MM-YYYY' : this.props.dateFormat,
        };
    }
    ...
    componentWillReceiveProps(nextProps) {
        if (this.state.selectedFormat !== nextProps.dateFormat) {
            this.setState({
                ...
                selectedFormat: nextProps.dateFormat === null ? 'DD-MM-YYYY' : nextProps.dateFormat,
            });
        }
    }
    ...
    render() {
        ...
        console.log('CURRENT PAGE------->', 'AuditCard');
        console.log('this.props---render', this.props, this.props.navigation);
        return (
            <View>
                <View
                    style={{
                    ...
                    <View style={{ flex: 0.03, backgroundColor: this.getColorCode(item.cStatus), margin: 10 }}></View>
