...
class AuditHeader extends Component {
  ...
  componentDidMount() {
    console.log("AuditHeader mounted.");
    ...
    auth.getCheckUser(userid,deviceId,token, (res, data) => {
      ...
      if (data.data.Message == "Success") {
        ...
        if (UserStatus == 2) {
          ...
          this.props.navigation.navigate(constant.ROUTES.GLOBAL_LOGIN);
      ...
      <View style={styles.wrapper}>
        ...
        >
          <View style={{ flexDirection: "row", padding: 10 }}>
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate(constant.ROUTES.PROFILE)}
            ...
            <TouchableOpacity
              onPress={() => this.props.navigation.navigate(constant.ROUTES.USER_PREFERENCE)}
              style={styles.footerMenuItem}
            >
