...
import { View, Text, StyleSheet, ImageBackground, FlatList, TouchableOpacity, Dimensions, ActivityIndicator,BackHandler, Platform, } from 'react-native'
...
getAuditCircleColor = (status,status_or_circle) => {
    ...
    allAudits() {
        return (
            <View tabLabel={strings.Upcomming} style={styles.scrollViewBody}>
