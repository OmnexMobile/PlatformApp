...
//   render() {
//     const JustAFlag = () => <Flag code="US" size={32} />;

//     const JustAFlagCN = () => <Flag code="CN" size={32} />;
...
//             {this.state.engMark === true ? (
//               <View style={styles.cont02}>
//                 <Text style={{fontSize: 25, color: 'black',marginLeft:20}}>Hello!</Text>
//                 <Text style={{fontSize: 18, color: 'grey',marginLeft:20}}>
//                   Your default language is English(US)
//                 </Text>
//               </View>
//             ) : (
//               <View style={styles.cont02}>
//                 <Text style={{fontSize: 25, color: 'black',marginLeft:20}}>你好！</Text>
//                 <Text style={{fontSize: 18, color: 'grey',marginLeft:20}}>
//                   您的默认语言是中文
//                 </Text>
//               </View>
...
//             </View>
//             <TouchableOpacity
//             onPress={this.LanguageChange.bind(this, 'English')}
//             style={styles.cont2}>
//             <View style={{flexDirection: 'row'}}>
//               <JustAFlag />
//               <Text
...
//           </TouchableOpacity>
//              <TouchableOpacity
//             onPress={this.LanguageChange.bind(this, 'Chinese')}
//             style={styles.cont2}>
//             <View style={{flexDirection: 'row'}}>
//               <JustAFlagCN />
//               <Text
