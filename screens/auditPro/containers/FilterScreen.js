...
import { View, Text, TouchableOpacity, ImageBackground, TextInput, ScrollView, TouchableWithoutFeedback, Platform } from 'react-native'
...
class FilterScreen extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            fromDashBoard: this.props.route?.params?.fromDashBoard,
            activeSection: "",
        }
