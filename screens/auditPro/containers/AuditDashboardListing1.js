...
class AuditDashboardListing extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      auditList: [],
      auditListAll: [],
      currentFilterId : this.props?.route?.params?.filterId,
      currentTitle: this.props?.route?.params?.title,
    };
  }

  componentDidMount() {
    console.log('this.filterId--->', this.filterId, this.props?.route?.params?.filterId)
    this.focusListener = this.props.navigation.addListener('focus', () => {
      console.log('AuditDashboardListing focused');
      this.getAudits();
      // Your code to run every time the screen is focused
    });
    this.blurListener = this.props.navigation.addListener('blur', () => {
      console.log('DetailsScreen unfocused');
    });
  ...
  getAudits() {
    console.log('filter getAudits calling', this.props?.route?.params?.filterId)
