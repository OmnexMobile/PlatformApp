...
class CameraCapture extends Component {
    ...
    if (this.camera) {
      ...
      try {
        ...
        var data = await RNFS.readFile(
          ...
          console.log('camera: ImgPath res1', ImgPath, res)
          newImgPath = newImgPath + '/' + newfileName;
          console.log('camera:New ImgPath1', newImgPath)
          ...
          .then(res => {
            console.log('camera: New ImgPath2', newImgPath,res)
            this.setState({
          ...
          console.log('end camera: New ImgPath2--->')
        });
        console.log('end camera: New ImgPath1--->')
      } catch (err) {
          console.log("camera:Error in Capture Image:",err);
      }
      console.log('end this.camera--->');
    }
    console.log('end capturePhoto--->')
  };

  deleteImageAfterEdit = async (filepath) => {
  ...
  saveCapturedImage = () => {
    console.log('reach saveCapturedImage--->')
    var cameraCapture = [];
  ...
  render() {
    ...
    console.log(this.state.captureState, 'captureState');
