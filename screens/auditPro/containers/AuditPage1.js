...
class AuditPage extends Component {
  ...
  componentWillReceiveProps(props) {
    ...
    if (CurrentPage == ROUTES.AUDIT_PAGE) {
      console.log('Audit summary page focussed!');
      console.log('12 AuditPage-datapass-->', this.props?.route?.params?.datapass);
      console.log('12 AuditPage-this.PROPS-->', this.props);
    ...
    if (CheckpointsDetails) {
      ...
      for (var i = 0; i < CheckpointsDetails.length; i++) {
        ...
        CheckData.push({
          ...
          Status: CheckpointsDetails[i].Status,
        });
      }
    }
                  ...
                  this.props.data.audits.smdata != 3 ? (
                    <View style={styles.lastCard}>
                      <View style={styles.boxCard1}>
                        ...
                        {/* // need to check <Text style={styles.detailTitle}>{strings.Traineeauditor}</Text> */}
                      </View>
                      <View style={styles.boxCard2}>
                        <Text numberOfLines={2} style={styles.detailContent}>
                          {this.state.auditDetailList.AuditorName
                  ...
                  this.state.auditDetailList.AuditProgramName !== 'LPA' ? (
                    <View style={styles.lastCard}>
                      <View style={styles.boxCard1}>
                        ...
                        {/* // need to check  <Text style={styles.detailTitle}>{strings.Audit_Agenda}</Text> */}
                      </View>
                      <View style={styles.boxCard2}>
                        <TouchableOpacity
                          onPress={once(this.onNavigationTo.bind(this))}>
                          <Text style={styles.detailContent1}>
                            {/* // need to check   {strings.View_Audit_Agenda} */}
                             {'View Audit Agenda'}
                          </Text>
                        </TouchableOpacity>
                      </View>
