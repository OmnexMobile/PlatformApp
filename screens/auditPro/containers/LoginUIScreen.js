...
import styles from '../styles/LoginUIScreenStyle1';
...
class LoginUIScreen1 extends Component {
  ...
  async componentDidMount() {
    ...
    console.log('cleanURL', this.propsServerUrl, '---', this.state.ssoEnabled.toString());
    await AsyncStorage.setItem('ssoenableflag', this.state.ssoEnabled.toString());
  ...
  getSsoCreds = async () => {
    try {
      ...
      if (
        ...
        console.log('ss_configs--->login', Object.keys(JSON.parse(ss_configs)).length, ss_configs);
