...
import { View, Text, Image, Dimensions, ScrollView, ImageBackground, Platform } from 'react-native';
        ...
        this.setState(
            {
                ...
                AuditProgramId: this.props?.route?.params?.AuditProgramId,
                AuditProgramOrder: this.props?.route?.params?.AuditProgramOrder,
                AuditOrder: this.props?.route?.params?.AuditOrder,
                AuditTypeId: this.props?.route?.params?.AuditTypeId,
    ...
    render() {
        ...
        return (
            <View style={styles.wrapper}>
                ...
                <OfflineNotice />
                <GlobalHeader
                    title={strings.Audit_Result_label}
                    ...
                    <ScrollableTabView
                        ...
                        <ScrollView tabLabel={strings.Templates} style={styles.scrollViewBody}>
                            {!this.state.isLoading ? (
                                this.state.AuditResultTemplates ? (
                                    this.state.AuditResultTemplates.length > 0 ? (
                                            ...
                                            {this.state.AuditResultTemplates.map((item, key) => (
                                                <View key={key} style={styles.cardBox}>
                                                    <View style={styles.sectionTop}>
                                                        ...
                                                        <View style={styles.sectionContent}>
                                                            <Text numberOfLines={2} style={styles.boxContent}>
                                                                {item.FormName}
                                                            </Text>
                                                        </View>
                                                    </View>
                                                    ...
                                                    <View style={styles.sectionBottom}>
                                                        ...
                                                        <View style={styles.sectionContent}>
                                                            <Text numberOfLines={1} style={styles.boxContent}>
                                                                {this.changeDateFormatCard(item.UploadedOn)}
                                                            </Text>
                                                        </View>
                                                    </View>
                                                </View>
                        ...
                        <ScrollView tabLabel={strings.References} style={styles.scrollViewBody}>
                            {!this.state.isLoading ? (
                                this.state.AuditResultReferences ? (
                                    this.state.AuditResultReferences.length > 0 ? (
                                        <View style={{ marginTop: 60 }}>
