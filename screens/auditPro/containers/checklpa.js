                    ...
                    if (checkPoints[i].RadioValue == 0) {
                      if (checkPointList?.[j]?.Status == 0) {
                        ...
                        checkPointsDetails.push({
                          ...
                          Modified: checkPoints?.[i]?.Modified,
                          checklistName: checkPointList?.[j]?.ChecklistName,
                          FailureCategoryId:checkPoints?.[i]?.FailureCategoryId,
                          FailureReasonId:checkPoints?.[i]?.FailureReasonId,
                          show_nc_ofi_status: showncofistatus,
                          nc_available_status: nc_available,
                          ofi_avialable_status: ofi_avialable,
                        });
                      ...
                      console.log('checkdetailpush===>18', checkPointList,checkPoints);
                      temppp = '18';
                      checkPointsDetails.push({
                        AuditId: this.props?.route?.params.AuditID,
                        ChecklistTemplateId:
                        ...
                        AttachforOfi: checkPoints?.[i]?.AttachforOfi,
                        Modified: checkPoints?.[i]?.Modified,
                        checklistName: checkPoints?.[i]?.ChecklistName,
                        FailureCategoryId:checkPoints?.[i]?.FailureCategoryId,
                        FailureReasonId:checkPoints?.[i]?.FailureReasonId,
                        show_nc_ofi_status: showncofistatus,
                        nc_available_status: nc_available,
                      ...
                      for (
                        ...
                        listDataArr.push({
                          ...
                          immediateAction:
                            ...
                            FailureCategoryId:auditRecordsOrg[p].Listdata[q].FailureCategoryId,
                            FailureReasonId:auditRecordsOrg[p].Listdata[q].FailureReasonId,
                          deleteallattachment:
                                ...
                                {this.state.ischeckLPA ? (
                                  <View
                                    style={
                                      ...
                                      {console.log(this.state.checkPointsDetails[index].FailureCategoryId,
                                                                                this.state.checkPointsDetails[index],
                                                                                "ap/venkat12")}
                                      {console.log(this.state.checkPointsDetails[index].ApproachId,"ap/venkat1")}

                                      {/* {console.log(this.failureCategoryText(this.state.checkPointsDetails[index].FailureCategoryId),'app3')} */}
