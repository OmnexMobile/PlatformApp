...
import {API_URL} from '../../../services/AuditPro-Api';
...
class Registration extends Component {
    ...
    this.state = {
      ...
      serverUrl:
        ...
        this.props?.data?.audits?.serverUrl == ''
          // ? API_URL
          ? 'https://omn-qa-forvia.ewqims.com/auditproapi/api/'
          : this.props?.data?.audits?.serverUrl,
      deviceId: '',
      type: 1,
    };
          ...
          if (this.props?.data?.audits?.isOfflineMode) {
            if (this.props?.data?.audits?.isDeviceRegistered) {
              if (!this.isRedirectFromLogin) {
                ...
                console.log('LOGINUISCREEN redirect-->1')
                this.props.navigation.navigate(ROUTES.LOGINUISCREEN, { projectTitle: this.props.route.params.title, status: this.props.route.params.projectStatus, category: this.props.route.params.category })
              } else {
                this.setState(
                  {
            ...
            console.log('this.state.deviceId', this.state.deviceId,this.state.serverUrl);
    ...
    NetInfo.fetch().then(netState => {
      ...
      if (netState.isConnected) {
            ...
            if (data.data) {
              ...
              if (data.data.Data) {
                ...
                if (
                  ...
                  Object.keys(data.data.Data.SSOFlags).length > 0 && isRegistered === true
                ) {
                ...
                if (
                  ...
                  console.log('if serverurl not empty then allowed!', data?.data?.Data?.ServerUrl);
                  if (
                    ...
                    console.log('reach storedserverrul!', data?.data?.Data?.ServerUrl);
                  }
                  ...
                  if (!this.isRedirectFromLogin) {
                    ...
                    this.props.storeDeviceid(this.state.deviceId);
                    // Forward to landing page
                    console.log('LOGINUISCREEN redirect-->2')
                    this.props.navigation.navigate(ROUTES.LOGINUISCREEN, { projectTitle: this.props.route.params.title, status: this.props.route.params.projectStatus, category: this.props.route.params.category })
                  } else {
                    this.setState(
                      {
                  ...
                  this.setState(
                    ...
                    async () => {
                      ...
                      this.props.storeDeviceid(this.state.deviceId);
                      console.log('isDeviceRegistered Not=>',this.state.isDeviceRegistered)
                ...
                this.setState(
                  ...
                  async () => {
                    ...
                    this.props.storeDeviceid(this.state.deviceId);
                    console.log('isDeviceRegistered server reach error =>',this.state.isDeviceRegistered)
                    this.refs.toast.show(
                      strings.server_reach_error,
                      2000,
                    );
                  },
                );
        ...
        if (this.props?.data?.audits?.isDeviceRegistered) {
          if (!this.isRedirectFromLogin) {
            // Forward to landing page
            console.log('LOGINUISCREEN redirect-->3')
            this.props.navigation.navigate(ROUTES.LOGINUISCREEN, { projectTitle: this.props.route.params.title, status: this.props.route.params.projectStatus, category: this.props.route.params.category })
          } else {
            this.setState(
              {
  ...
  storeSSoCreds = async sso => {
    ...
    sso = (sso === undefined || sso === null || sso === "" || sso !== true || sso !== 'true' ? 'false': 'true');
                          ...
                          if (type == 1) {
                            ...
                            this.setState(
                              ...
                              async () => {
                                ...
                                this.props.storeDeviceid(this.state.deviceId);
                                // Forward to landing page
                                console.log('LOGINUISCREEN redirect-->4')
                                this.props.navigation.navigate(ROUTES.LOGINUISCREEN, { projectTitle: this.props.route.params.title, status: this.props.route.params.projectStatus, category: this.props.route.params.category })
                              },
                            );
                          } else {
  ...
  backFromReg = () => {
    console.log('reach here--->', this.state.isDeviceRegistered)
    if (this.state.isDeviceRegistered) {
        this.props.navigation.navigate(ROUTES.LOGINUISCREEN, { projectTitle: this.props.route.params.title, status: this.props.route.params.projectStatus, category: this.props.route.params.category })
      console.log('redirect here login--->')
    }
  };
