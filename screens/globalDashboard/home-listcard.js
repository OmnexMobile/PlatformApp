                                ...
                                <>
                                    <Ripple
                                        ...
                                        <ImageComponent
                                            resizeMode="contain"
                                            source={
                                                item.Module_name === 'AuditPro'
                                                    ? IMAGES.auditpro_logo
                                                    : ['Supplier Initial Assessment', 'Supplier Routine Audit'].includes(item.Module_name)
                                                    ? IMAGES.supplier_logo
                                                    : IMAGES.ps_logo_round
