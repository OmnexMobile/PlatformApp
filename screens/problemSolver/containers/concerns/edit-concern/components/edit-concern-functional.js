...
const EditConcernFunctional = () => {
                    ...
                    ...tempDynamicInputs?.map(input => {
                        ...
                        return {
                            ...
                            ...(input?.name === 'EstimatedTotalCost' && {
                                label: `${input?.label} ${
                                    stateVariables?.concernDetails?.['ShortName'] ? `(${stateVariables?.concernDetails?.['ShortName']})` : ''
                                }`,
                            }),
                            // editable: true,
        ...
        () => [
            {
                ...
                editable: stateVariables?.concernDetails?.StatusID !== STATUS_CODES.InprogressConcern,
            },
            {
                label: 'Sub Category',
                name: 'SubCategoryID',
    ...
    const getListData = res => {
        ...
        console.log('🚀 ~ defaultObj ~:', defaultObj, res);
        dispatch(
